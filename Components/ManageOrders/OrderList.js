          ...
          {initialLoading || loading ? (
            ...
            myorders.length == 0 ? (
              <View style={{ alignItems: 'center', justifyContent: 'center', marginTop: 100 }}>
                <Image
                  source={require('../../assets/orders.png')} // 👈 path to your image
                      ...
                      <View style={{ width: '85%' }}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 30 }}>
                          ...
                          {hasmarginPermissions &&
                            <TouchableOpacity onLongPress={() => fetchorderdetails(item.order_no)} style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
                              <Text style={{ fontFamily: 'Inter-Bold', fontSize: 14, color: '#173161' }}>Margin:
                                <Text style={{ fontFamily: 'Inter-Regular', fontSize: 14, color: '#173161', textTransform: 'uppercase' }}> {Math.round(item.total_profit_one_box)}
                                </Text>
                              </Text>
                            </TouchableOpacity>}
                        </View>
          ...
          >
            ...
            {orderdetails && orderdetails.length > 0 && (
              <Text style={{ fontSize: 14, fontFamily: 'Inter-SemiBold', color: '#666', marginBottom: 2, marginLeft: 10 }}>
                Order No: {orderdetails[0].order_no || 'N/A'}
              </Text>
            )}
