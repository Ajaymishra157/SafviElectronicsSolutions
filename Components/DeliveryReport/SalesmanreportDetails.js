...
const SalesmanreportDetails = ({ navigation, route }) => {
    const { startdate, enddate, userid, created_order, order_qty, name } = route.params || {}
    ...
    const fetchdeliverymanreport = async () => {
        ...
        const url = `${Constant.URL}${Constant.OtherURL.salesmen_detail}`;
                    ...
                    <>
                        ...
                        <View style={{ borderRadius: 10, padding: 10, marginBottom: 10, borderColor: '#173161', borderWidth: 1, backgroundColor: '#fff' }}>
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                <View>
                                    <Text style={{ fontFamily: 'Inter-Bold', fontSize: 14, color: '#173161' }}>Total Orders</Text>
                                    <Text style={{ fontFamily: 'Inter-Regular', textAlign: 'center', fontSize: 14, color: '#173161' }}>{created_order}</Text>
                                </View>
                                <View>
                                    <Text style={{ fontFamily: 'Inter-Bold', fontSize: 14, color: '#173161' }}>Total</Text>
                                    <Text style={{ fontFamily: 'Inter-Regular', textAlign: 'center', fontSize: 14, color: '#173161' }}>{order_qty} (Box)</Text>
                                </View>
                            </View>
                        </View>
...
export default SalesmanreportDetails